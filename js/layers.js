...
const LayersModule = (() => {
  ...
  const LAYER_DEFS = [
    ...
    { id: 'health-units',    name: 'Health Units',      file: 'data/health_units.geojson',    group: 'Health',          category: 'health',         geometry: 'point',   color: '#f97316', icon: 'fa-heart-pulse',         visible: true  },
